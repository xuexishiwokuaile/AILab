...
var QueueAnim = function (_React$Component) {
  ...
  (0, _createClass3['default'])(QueueAnim, null, [{
    ...
    value: function getDerivedStateFromProps(props, _ref) {
      ...
      if (prevProps && props !== prevProps) {
        ...
        if (children.length) {
           ...
           * 所以这里需要处理出场完成的元素做清除。
           */
          var stateChildren = (0, _utils.mergeChildren)(currentChildren, children);
          var currentChild = [];
        ...
        currentChildren.forEach(function (c) {
          ...
          if (!hasNext && key) {
            ...
            _rcTweenOne.ticker.clear($self.placeholderTimeoutIds[key]);
  ...
  function QueueAnim(props) {
     ...
     */
    var _this = (0, _possibleConstructorReturn3['default'])(this, (QueueAnim.__proto__ || Object.getPrototypeOf(QueueAnim)).call(this, props));
  ...
  (0, _createClass3['default'])(QueueAnim, [{
    ...
    value: function componentWillUnmount() {
      ...
      Object.keys(this.placeholderTimeoutIds).forEach(function (key) {
        _rcTweenOne.ticker.clear(_this2.placeholderTimeoutIds[key]);
      });
      this.keysToEnter = [];
      this.keysToLeave = [];
      this.childrenShow = {};
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          tagProps = (0, _objectWithoutProperties3['default'])(_props, ['component', 'componentProps', 'interval', 'duration', 'delay', 'type', 'animConfig', 'ease', 'leaveReverse', 'animatingClassName', 'forcedReplay', 'onEnd', 'appear']);

      if (_utils.windowIsUndefined) {
        return (0, _react.createElement)(component, (0, _extends3['default'])({}, tagProps, componentProps), this.props.children);
      }
...
QueueAnim.propTypes = {
  ...
  forcedReplay: _propTypes2['default'].bool,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getChildrenToRender = function (child) {
    ...
    if (i >= 0) {
      ...
      var $interval = (0, _utils.transformArguments)(interval, key, i)[1];
      var $delay = (0, _utils.transformArguments)(delay, key, i)[1];
      ...
      // 处理进场;
      i = (0, _utils.toArrayChildren)(children).findIndex(function (c) {
        return c && c.key === key;
      });
      ref = function ref(c) {
      ...
      if (_this5.tweenToEnter[key] && !forcedReplay) {
        // 如果是已进入的，将直接返回标签。。
        return (0, _react.createElement)(_rcTweenOne2['default'], {
          key: key,
    ...
    var tag = (0, _react.createElement)(_rcTweenOne2['default'], {
      key: key,
      component: child.type,
      forcedJudg: forcedJudg,
      componentProps: child.props,
  ...
  this.leaveComplete = function (key, e) {
    ...
    if ((0, _utils.toArrayChildren)(_this5.props.children).findIndex(function (c) {
      return c && c.key === key;
    }) >= 0) {
      return;
    }
...
exports['default'] = (0, _reactLifecyclesCompat.polyfill)(QueueAnim);
